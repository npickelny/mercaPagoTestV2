...
class TodoPagoConector
  ...
  def initialize(j_header_http, j_wsdls = nil, end_point = nil)#j_wsdl=nil, endpoint=nil, env=nil
      @discover      = nil
      @Fcv           = nil
      @restConnector = RestConnector.new(j_header_http, j_wsdls, end_point)
      @soapConnector = SoapConnector.new(j_header_http, j_wsdls, end_point)
  end
